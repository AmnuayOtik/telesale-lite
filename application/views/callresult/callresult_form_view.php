...
$x_id = isset($callresult['id']) ? $callresult['id'] : '';
$x_name_th = isset($callresult['name_th']) ? $callresult['name_th'] : '';
$user_id = $this->session->userdata('user_id');

?>

<div class="modal fade" id="CallResultModal">
                        ...
                        <div class="card-body" id="FormCallResult">
                            ...
                            <div class="tab-content" id="custom-tabs-four-tabContent">
                                <div class="tab-pane fade active show" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                    ...
                                    <form name="frmCallResult" action="CallResult/FcSaveOrEdit" method="post" id="frmCallResult">
...
<script>
    ...
    function FcCallResultSaveOrEdit() {
        ...
        const formData = $('#frmCallResult').serialize();
        ...
        $.ajax({
            url: $('#frmCallResult').attr('action'), // ใช้ URL จากค่า action ของฟอร์ม
            ...
            success: function(response) {
                try {
                    ...
                    if (response.rCode === 200 && response.rMsg === 'Success') {
                        ...
                        $('#CallResultModal').modal('hide'); // ปิด modal หลังจากบันทึกสำเร็จ
