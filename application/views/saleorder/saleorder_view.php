                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header border-0">
                            <h3 class="card-title">แสดงรายการขายสินค้า</h3>
                        ...
                        <div class="card-body table-responsive" style="padding: 20px !important;" id="SaleOrderTableBody" >
...
<script>
    ...
    *********************************************************/ 
    function fcReloadCustomerTable() {
        $.get('SaleOrder/FcSaleOrderTables', function(response) {
            $('#SaleOrderTableBody').html(response);
        }).fail(function() {
            toastr.error('เกิดข้อผิดพลาดในการเชื่อมต่อ');
        });
    }
